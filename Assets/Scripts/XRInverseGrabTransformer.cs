...
namespace UnityEngine.XR.Interaction.Toolkit.Transformers
{
    ...
    [BurstCompile]
#endif
    public class XRInverseGrabTransformer : XRBaseGrabTransformer
    {
        /// <summary>
        ...
        void UpdateTarget(XRGrabInteractable grabInteractable, ref Pose targetPose)
        {
            ...
            Quaternion targetRotation = ComputeNewObjectRotation(adjustedInteractorRotation, grabInteractable.trackRotation);


            // Convert to Euler angles, zero the Z rotation, and convert back to quaternion
            Vector3 eulerRotation = targetRotation.eulerAngles;
            eulerRotation.z = 0; // Keep local Z rotation at 0
            targetRotation = Quaternion.Euler(eulerRotation);

            targetPose.rotation = Quaternion.Inverse(targetRotation);
        }
    }
}
